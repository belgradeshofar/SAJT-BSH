    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-900 to-blue-600 text-white px-6">
      <div className="max-w-3xl w-full bg-white shadow-lg rounded-2xl p-8 text-gray-800">
        ...
        <p className="text-center text-gray-600 text-lg mt-4">
          Ova stranica je trenutno u pripremi. Uskoro ćete moći da podržite naš rad putem sigurne donacije.
        </p>
        <p className="text-center text-gray-500 mt-2">
          This page is currently under preparation. Soon, you will be able to support our work through secure donations.
        </p>
