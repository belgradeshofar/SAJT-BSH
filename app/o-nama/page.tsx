  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[#102854] text-white py-20 rounded-lg mx-4">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto">
            BELGRADE SHOFAR je vodeći news portal koji prikuplja i prenosi najnovije i najpouzdanije vesti iz Izraela.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-800 text-lg mb-6">
              Naša misija je da obezbedimo tačne, pravovremene i nepristrasne informacije, inspirišući i osnažujući našu publiku da bude informisana o svim ključnim događajima iz Izraela.
            </p>
            <h2 className="text-3xl font-bold mb-4">Naša Vizija</h2>
            <p className="text-gray-800 text-lg">
              Težimo da postanemo primarni izvor vesti u regionu, koristeći inovativne tehnologije i najmodernije novinarske prakse kako bismo osigurali visok kvalitet i kredibilitet informacija.
            </p>
          </div>
          <div>
            <img
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center px-4">
              ...
              <p className="text-gray-700">
                Poštujemo novinarsku etiku, istinu i nepristrasnost u svakom izveštaju.
              </p>
            </div>
            <div className="text-center px-4">
              <h3 className="text-2xl font-semibold mb-2">Preciznost</h3>
              <p className="text-gray-700">
                Naša posvećenost detaljima osigurava da svaka vest bude proverena i tačna.
              </p>
            </div>
            <div className="text-center px-4">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Primer člana tima – dodajte koliko želite */}
      ...
      <section className="bg-[#102854] text-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-6">
            Ukoliko verujete u moć istinitog i nepristrasnog novinarstva, budite deo zajednice koja oblikuje budućnost informisanja.
          </p>
          <a
            href="/kontakt"
